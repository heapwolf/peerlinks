...
$root.Shake = (function() {
    ...
    Shake.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Shake();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
...
$root.Link = (function() {
    ...
    Link.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.tbs != null && message.hasOwnProperty("tbs")) {
            var error = $root.Link.TBS.verify(message.tbs);
            if (error)
                return "tbs." + error;
        }
        if (message.signature != null && message.hasOwnProperty("signature"))
    ...
    Link.TBS = (function() {
        ...
        TBS.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Link.TBS();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
...
$root.Invite = (function() {
    ...
    Invite.encode = function encode(message, writer) {
        ...
        if (message.chain != null && message.chain.length)
            for (var i = 0; i < message.chain.length; ++i)
    ...
    Invite.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Invite();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    Invite.verify = function verify(message) {
        ...
        if (message.chain != null && message.hasOwnProperty("chain")) {
            ...
            for (var i = 0; i < message.chain.length; ++i) {
                var error = $root.Link.verify(message.chain[i]);
                if (error)
                    return "chain." + error;
            }
        }
    ...
    Invite.fromObject = function fromObject(object) {
        ...
        if (object.chain) {
            ...
            message.chain = [];
            for (var i = 0; i < object.chain.length; ++i) {
    ...
    Invite.toObject = function toObject(message, options) {
        ...
        if (message.chain && message.chain.length) {
            object.chain = [];
            for (var j = 0; j < message.chain.length; ++j)
...
$root.EncryptedInvite = (function() {
    ...
    EncryptedInvite.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.EncryptedInvite();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    EncryptedInvite.fromObject = function fromObject(object) {
        if (object instanceof $root.EncryptedInvite)
            return object;
        var message = new $root.EncryptedInvite();
...
$root.ChannelMessage = (function() {
    ...
    ChannelMessage.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.tbs != null && message.hasOwnProperty("tbs")) {
            var error = $root.ChannelMessage.TBS.verify(message.tbs);
            if (error)
                return "tbs." + error;
        }
        if (message.signature != null && message.hasOwnProperty("signature"))
    ...
    ChannelMessage.Root = (function() {
        ...
        Root.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChannelMessage.Root();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
    ...
    ChannelMessage.Body = (function() {
        ...
        Body.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChannelMessage.Body();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Body.verify = function verify(message) {
            ...
            if (message.root != null && message.hasOwnProperty("root")) {
                properties.body = 1;
                {
                    var error = $root.ChannelMessage.Root.verify(message.root);
                    if (error)
                        return "root." + error;
                }
            }
        ...
        Body.fromObject = function fromObject(object) {
            if (object instanceof $root.ChannelMessage.Body)
                return object;
            var message = new $root.ChannelMessage.Body();
            if (object.root != null) {
    ...
    ChannelMessage.TBS = (function() {
        ...
        TBS.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChannelMessage.TBS();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        TBS.verify = function verify(message) {
            ...
            if (message.body != null && message.hasOwnProperty("body")) {
                var error = $root.ChannelMessage.Body.verify(message.body);
                if (error)
                    return "body." + error;
            }
            return null;
        ...
        TBS.fromObject = function fromObject(object) {
            if (object instanceof $root.ChannelMessage.TBS)
                return object;
            var message = new $root.ChannelMessage.TBS();
            if (object.parents) {
...
$root.QueryResponse = (function() {
    ...
    QueryResponse.encode = function encode(message, writer) {
        ...
        if (message.abbreviatedMessages != null && message.abbreviatedMessages.length)
            for (var i = 0; i < message.abbreviatedMessages.length; ++i)
    ...
    QueryResponse.verify = function verify(message) {
        ...
        if (message.abbreviatedMessages != null && message.hasOwnProperty("abbreviatedMessages")) {
            ...
            for (var i = 0; i < message.abbreviatedMessages.length; ++i) {
                var error = $root.QueryResponse.Abbreviated.verify(message.abbreviatedMessages[i]);
                if (error)
    ...
    QueryResponse.fromObject = function fromObject(object) {
        ...
        if (object.abbreviatedMessages) {
            ...
            message.abbreviatedMessages = [];
            for (var i = 0; i < object.abbreviatedMessages.length; ++i) {
    ...
    QueryResponse.toObject = function toObject(message, options) {
        ...
        if (message.abbreviatedMessages && message.abbreviatedMessages.length) {
            object.abbreviatedMessages = [];
            for (var j = 0; j < message.abbreviatedMessages.length; ++j)
    ...
    QueryResponse.Abbreviated = (function() {
        ...
        Abbreviated.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.QueryResponse.Abbreviated();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Abbreviated.fromObject = function fromObject(object) {
            if (object instanceof $root.QueryResponse.Abbreviated)
                return object;
            var message = new $root.QueryResponse.Abbreviated();
            if (object.parents) {
                if (!Array.isArray(object.parents))
...
$root.Bulk = (function() {
    ...
    Bulk.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Bulk();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
...
$root.BulkResponse = (function() {
    ...
    BulkResponse.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.BulkResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    BulkResponse.verify = function verify(message) {
        ...
        if (message.messages != null && message.hasOwnProperty("messages")) {
            ...
            for (var i = 0; i < message.messages.length; ++i) {
                var error = $root.ChannelMessage.verify(message.messages[i]);
                if (error)
    ...
    BulkResponse.fromObject = function fromObject(object) {
        if (object instanceof $root.BulkResponse)
            return object;
        var message = new $root.BulkResponse();
        if (object.messages) {
...
$root.SyncRequest = (function() {
    ...
    SyncRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SyncRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    SyncRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.SyncRequest)
            return object;
        var message = new $root.SyncRequest();
        if (object.channelId != null)
            if (typeof object.channelId === "string")
                $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0);
            else if (object.channelId.length)
    ...
    SyncRequest.TBS = (function() {
        ...
        TBS.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SyncRequest.TBS();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        TBS.verify = function verify(message) {
            ...
            if (message.query != null && message.hasOwnProperty("query")) {
                ...
                {
                    var error = $root.Query.verify(message.query);
                    if (error)
                        return "query." + error;
                }
            }
            if (message.bulk != null && message.hasOwnProperty("bulk")) {
                ...
                properties.content = 1;
                {
                    var error = $root.Bulk.verify(message.bulk);
                    if (error)
                        return "bulk." + error;
                }
            }
        ...
        TBS.fromObject = function fromObject(object) {
            if (object instanceof $root.SyncRequest.TBS)
                return object;
            var message = new $root.SyncRequest.TBS();
            if (object.chain) {
                if (!Array.isArray(object.chain))
    ...
    SyncRequest.Content = (function() {
        ...
        Content.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SyncRequest.Content();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Content.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.tbs != null && message.hasOwnProperty("tbs")) {
                var error = $root.SyncRequest.TBS.verify(message.tbs);
                if (error)
                    return "tbs." + error;
            }
            if (message.signature != null && message.hasOwnProperty("signature"))
        ...
        Content.fromObject = function fromObject(object) {
            if (object instanceof $root.SyncRequest.Content)
                return object;
            var message = new $root.SyncRequest.Content();
            if (object.tbs != null) {
                if (typeof object.tbs !== "object")
...
$root.SyncResponse = (function() {
    ...
    SyncResponse.Content = (function() {
        ...
        Content.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SyncResponse.Content();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Content.verify = function verify(message) {
            ...
            if (message.queryResponse != null && message.hasOwnProperty("queryResponse")) {
                properties.content = 1;
                {
                    var error = $root.QueryResponse.verify(message.queryResponse);
                    if (error)
            ...
            if (message.bulkResponse != null && message.hasOwnProperty("bulkResponse")) {
                ...
                properties.content = 1;
                {
                    var error = $root.BulkResponse.verify(message.bulkResponse);
                    if (error)
        ...
        Content.fromObject = function fromObject(object) {
            if (object instanceof $root.SyncResponse.Content)
                return object;
            var message = new $root.SyncResponse.Content();
...
$root.Packet = (function() {
    ...
    Packet.verify = function verify(message) {
        ...
        if (message.invite != null && message.hasOwnProperty("invite")) {
            ...
            properties.content = 1;
            {
                var error = $root.EncryptedInvite.verify(message.invite);
                if (error)
                    return "invite." + error;
            }
        }
        if (message.syncRequest != null && message.hasOwnProperty("syncRequest")) {
            ...
            properties.content = 1;
            {
                var error = $root.SyncRequest.verify(message.syncRequest);
                if (error)
        ...
        if (message.syncResponse != null && message.hasOwnProperty("syncResponse")) {
            ...
            properties.content = 1;
            {
                var error = $root.SyncResponse.verify(message.syncResponse);
                if (error)
...
$root.Identity = (function() {
    ...
    Identity.encode = function encode(message, writer) {
        ...
        if (message.channelChains != null && message.channelChains.length)
            for (var i = 0; i < message.channelChains.length; ++i)
    ...
    Identity.verify = function verify(message) {
        ...
        if (message.channelChains != null && message.hasOwnProperty("channelChains")) {
            ...
            for (var i = 0; i < message.channelChains.length; ++i) {
                var error = $root.Identity.ChannelChain.verify(message.channelChains[i]);
                if (error)
    ...
    Identity.fromObject = function fromObject(object) {
        ...
        if (object.channelChains) {
            ...
            message.channelChains = [];
            for (var i = 0; i < object.channelChains.length; ++i) {
    ...
    Identity.toObject = function toObject(message, options) {
        ...
        if (message.channelChains && message.channelChains.length) {
            object.channelChains = [];
            for (var j = 0; j < message.channelChains.length; ++j)
    ...
    Identity.ChannelChain = (function() {
        ...
        ChannelChain.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Identity.ChannelChain();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        ChannelChain.fromObject = function fromObject(object) {
            if (object instanceof $root.Identity.ChannelChain)
                return object;
            var message = new $root.Identity.ChannelChain();
            if (object.channelId != null)
                if (typeof object.channelId === "string")
                    $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0);
                else if (object.channelId.length)
