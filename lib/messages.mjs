...
export const Hello = $root.Hello = (() => {
  ...
  Hello.encode = function encode (message, writer) {
    ...
    if (message.version != null && message.hasOwnProperty('version')) { writer.uint32(/* id 1, wireType 0 = */8).uint32(message.version) }
    if (message.peerId != null && message.hasOwnProperty('peerId')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.peerId) }
    return writer
  }
  ...
  Hello.decode = function decode (reader, length) {
    ...
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Hello()
  ...
  Hello.verify = function verify (message) {
    ...
    if (message.peerId != null && message.hasOwnProperty('peerId')) {
      if (!(message.peerId && typeof message.peerId.length === 'number' || $util.isString(message.peerId))) { return 'peerId: buffer expected' }
    }
    return null
  }
  ...
  Hello.fromObject = function fromObject (object) {
    if (object instanceof $root.Hello) { return object }
    const message = new $root.Hello()
    if (object.version != null) { message.version = object.version >>> 0 }
    if (object.peerId != null) {
      if (typeof object.peerId === 'string') { $util.base64.decode(object.peerId, message.peerId = $util.newBuffer($util.base64.length(object.peerId)), 0) } else if (object.peerId.length) { message.peerId = object.peerId }
    }
    return message
  }
  ...
  Hello.toObject = function toObject (message, options) {
    ...
    if (options.defaults) {
      object.version = 0
      if (options.bytes === String) { object.peerId = '' } else {
        object.peerId = []
        if (options.bytes !== Array) { object.peerId = $util.newBuffer(object.peerId) }
      }
    }
    if (message.version != null && message.hasOwnProperty('version')) { object.version = message.version }
    if (message.peerId != null && message.hasOwnProperty('peerId')) { object.peerId = options.bytes === String ? $util.base64.encode(message.peerId, 0, message.peerId.length) : options.bytes === Array ? Array.prototype.slice.call(message.peerId) : message.peerId }
    return object
  }
...
export const Shake = $root.Shake = (() => {
  ...
  Shake.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.isDuplicate != null && message.hasOwnProperty('isDuplicate')) { writer.uint32(/* id 1, wireType 0 = */8).bool(message.isDuplicate) }
    return writer
  }
  ...
  Shake.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Shake()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Shake.verify = function verify (message) {
    ...
    if (message.isDuplicate != null && message.hasOwnProperty('isDuplicate')) {
      if (typeof message.isDuplicate !== 'boolean') { return 'isDuplicate: boolean expected' }
    }
    return null
  }
  ...
  Shake.fromObject = function fromObject (object) {
    if (object instanceof $root.Shake) { return object }
    const message = new $root.Shake()
    if (object.isDuplicate != null) { message.isDuplicate = Boolean(object.isDuplicate) }
    return message
  }
  ...
  Shake.toObject = function toObject (message, options) {
    if (!options) { options = {} }
    const object = {}
    if (options.defaults) { object.isDuplicate = false }
    if (message.isDuplicate != null && message.hasOwnProperty('isDuplicate')) { object.isDuplicate = message.isDuplicate }
    return object
  }
...
export const Link = $root.Link = (() => {
  ...
  Link.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.tbs != null && message.hasOwnProperty('tbs')) { $root.Link.TBS.encode(message.tbs, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
    if (message.signature != null && message.hasOwnProperty('signature')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.signature) }
    return writer
  }
  ...
  Link.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Link()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Link.verify = function verify (message) {
    ...
    if (message.tbs != null && message.hasOwnProperty('tbs')) {
      const error = $root.Link.TBS.verify(message.tbs)
      if (error) { return 'tbs.' + error }
    }
  ...
  Link.fromObject = function fromObject (object) {
    if (object instanceof $root.Link) { return object }
    const message = new $root.Link()
    if (object.tbs != null) {
      if (typeof object.tbs !== 'object') { throw TypeError('.Link.tbs: object expected') }
  ...
  Link.toObject = function toObject (message, options) {
    ...
    if (message.tbs != null && message.hasOwnProperty('tbs')) { object.tbs = $root.Link.TBS.toObject(message.tbs, options) }
  ...
  Link.TBS = (function () {
    ...
    TBS.encode = function encode (message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.trusteePubKey != null && message.hasOwnProperty('trusteePubKey')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.trusteePubKey) }
      if (message.trusteeDisplayName != null && message.hasOwnProperty('trusteeDisplayName')) { writer.uint32(/* id 2, wireType 2 = */18).string(message.trusteeDisplayName) }
      if (message.validFrom != null && message.hasOwnProperty('validFrom')) { writer.uint32(/* id 3, wireType 1 = */25).double(message.validFrom) }
      if (message.validTo != null && message.hasOwnProperty('validTo')) { writer.uint32(/* id 4, wireType 1 = */33).double(message.validTo) }
      if (message.channelId != null && message.hasOwnProperty('channelId')) { writer.uint32(/* id 5, wireType 2 = */42).bytes(message.channelId) }
      return writer
    }
    ...
    TBS.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Link.TBS()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    TBS.verify = function verify (message) {
      ...
      if (message.trusteePubKey != null && message.hasOwnProperty('trusteePubKey')) {
        if (!(message.trusteePubKey && typeof message.trusteePubKey.length === 'number' || $util.isString(message.trusteePubKey))) { return 'trusteePubKey: buffer expected' }
      }
      if (message.trusteeDisplayName != null && message.hasOwnProperty('trusteeDisplayName')) {
        if (!$util.isString(message.trusteeDisplayName)) { return 'trusteeDisplayName: string expected' }
      }
      if (message.validFrom != null && message.hasOwnProperty('validFrom')) {
        if (typeof message.validFrom !== 'number') { return 'validFrom: number expected' }
      }
      if (message.validTo != null && message.hasOwnProperty('validTo')) {
        if (typeof message.validTo !== 'number') { return 'validTo: number expected' }
      }
      if (message.channelId != null && message.hasOwnProperty('channelId')) {
        if (!(message.channelId && typeof message.channelId.length === 'number' || $util.isString(message.channelId))) { return 'channelId: buffer expected' }
      }
      return null
    }
    ...
    TBS.fromObject = function fromObject (object) {
      if (object instanceof $root.Link.TBS) { return object }
      const message = new $root.Link.TBS()
      if (object.trusteePubKey != null) {
        if (typeof object.trusteePubKey === 'string') { $util.base64.decode(object.trusteePubKey, message.trusteePubKey = $util.newBuffer($util.base64.length(object.trusteePubKey)), 0) } else if (object.trusteePubKey.length) { message.trusteePubKey = object.trusteePubKey }
      }
      if (object.trusteeDisplayName != null) { message.trusteeDisplayName = String(object.trusteeDisplayName) }
      if (object.validFrom != null) { message.validFrom = Number(object.validFrom) }
      if (object.validTo != null) { message.validTo = Number(object.validTo) }
      if (object.channelId != null) {
        if (typeof object.channelId === 'string') { $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0) } else if (object.channelId.length) { message.channelId = object.channelId }
      }
      return message
    }
    ...
    TBS.toObject = function toObject (message, options) {
      ...
      const object = {}
      if (options.defaults) {
        if (options.bytes === String) { object.trusteePubKey = '' } else {
          object.trusteePubKey = []
          if (options.bytes !== Array) { object.trusteePubKey = $util.newBuffer(object.trusteePubKey) }
        }
        object.trusteeDisplayName = ''
        object.validFrom = 0
        object.validTo = 0
        if (options.bytes === String) { object.channelId = '' } else {
          object.channelId = []
          if (options.bytes !== Array) { object.channelId = $util.newBuffer(object.channelId) }
        }
      }
      if (message.trusteePubKey != null && message.hasOwnProperty('trusteePubKey')) { object.trusteePubKey = options.bytes === String ? $util.base64.encode(message.trusteePubKey, 0, message.trusteePubKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.trusteePubKey) : message.trusteePubKey }
      if (message.trusteeDisplayName != null && message.hasOwnProperty('trusteeDisplayName')) { object.trusteeDisplayName = message.trusteeDisplayName }
      if (message.validFrom != null && message.hasOwnProperty('validFrom')) { object.validFrom = options.json && !isFinite(message.validFrom) ? String(message.validFrom) : message.validFrom }
      if (message.validTo != null && message.hasOwnProperty('validTo')) { object.validTo = options.json && !isFinite(message.validTo) ? String(message.validTo) : message.validTo }
      if (message.channelId != null && message.hasOwnProperty('channelId')) { object.channelId = options.bytes === String ? $util.base64.encode(message.channelId, 0, message.channelId.length) : options.bytes === Array ? Array.prototype.slice.call(message.channelId) : message.channelId }
      return object
    }
...
export const Invite = $root.Invite = (() => {
  ...
  Invite.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.channelPubKey != null && message.hasOwnProperty('channelPubKey')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.channelPubKey) }
    if (message.channelName != null && message.hasOwnProperty('channelName')) { writer.uint32(/* id 2, wireType 2 = */18).string(message.channelName) }
    if (message.chain != null && message.chain.length) {
      for (let i = 0; i < message.chain.length; ++i) { $root.Link.encode(message.chain[i], writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim() }
    }
    return writer
  }
  ...
  Invite.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Invite()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          break
        case 3:
          if (!(message.chain && message.chain.length)) { message.chain = [] }
  ...
  Invite.verify = function verify (message) {
    ...
    if (message.channelPubKey != null && message.hasOwnProperty('channelPubKey')) {
      if (!(message.channelPubKey && typeof message.channelPubKey.length === 'number' || $util.isString(message.channelPubKey))) { return 'channelPubKey: buffer expected' }
    }
    ...
    if (message.chain != null && message.hasOwnProperty('chain')) {
      if (!Array.isArray(message.chain)) { return 'chain: array expected' }
      for (let i = 0; i < message.chain.length; ++i) {
        const error = $root.Link.verify(message.chain[i])
  ...
  Invite.fromObject = function fromObject (object) {
    ...
    const message = new $root.Invite()
    if (object.channelPubKey != null) {
      if (typeof object.channelPubKey === 'string') { $util.base64.decode(object.channelPubKey, message.channelPubKey = $util.newBuffer($util.base64.length(object.channelPubKey)), 0) } else if (object.channelPubKey.length) { message.channelPubKey = object.channelPubKey }
    }
    if (object.channelName != null) { message.channelName = String(object.channelName) }
    if (object.chain) {
      if (!Array.isArray(object.chain)) { throw TypeError('.Invite.chain: array expected') }
      message.chain = []
      for (let i = 0; i < object.chain.length; ++i) {
        if (typeof object.chain[i] !== 'object') { throw TypeError('.Invite.chain: object expected') }
  ...
  Invite.toObject = function toObject (message, options) {
    if (!options) { options = {} }
    const object = {}
    if (options.arrays || options.defaults) { object.chain = [] }
    if (options.defaults) {
      if (options.bytes === String) { object.channelPubKey = '' } else {
        object.channelPubKey = []
        if (options.bytes !== Array) { object.channelPubKey = $util.newBuffer(object.channelPubKey) }
      }
      object.channelName = ''
    }
    if (message.channelPubKey != null && message.hasOwnProperty('channelPubKey')) { object.channelPubKey = options.bytes === String ? $util.base64.encode(message.channelPubKey, 0, message.channelPubKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.channelPubKey) : message.channelPubKey }
    ...
    if (message.chain && message.chain.length) {
      object.chain = []
      for (let j = 0; j < message.chain.length; ++j) { object.chain[j] = $root.Link.toObject(message.chain[j], options) }
    }
    return object
  }
...
export const EncryptedInvite = $root.EncryptedInvite = (() => {
  ...
  EncryptedInvite.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.requestId != null && message.hasOwnProperty('requestId')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.requestId) }
    if (message.box != null && message.hasOwnProperty('box')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.box) }
    return writer
  }
  ...
  EncryptedInvite.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.EncryptedInvite()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  EncryptedInvite.verify = function verify (message) {
    ...
    if (message.box != null && message.hasOwnProperty('box')) {
      if (!(message.box && typeof message.box.length === 'number' || $util.isString(message.box))) { return 'box: buffer expected' }
    }
    return null
  }
  ...
  EncryptedInvite.fromObject = function fromObject (object) {
    if (object instanceof $root.EncryptedInvite) { return object }
    const message = new $root.EncryptedInvite()
    if (object.requestId != null) {
      if (typeof object.requestId === 'string') { $util.base64.decode(object.requestId, message.requestId = $util.newBuffer($util.base64.length(object.requestId)), 0) } else if (object.requestId.length) { message.requestId = object.requestId }
    }
    if (object.box != null) {
      if (typeof object.box === 'string') { $util.base64.decode(object.box, message.box = $util.newBuffer($util.base64.length(object.box)), 0) } else if (object.box.length) { message.box = object.box }
    }
    return message
  }
  ...
  EncryptedInvite.toObject = function toObject (message, options) {
    ...
    const object = {}
    if (options.defaults) {
      if (options.bytes === String) { object.requestId = '' } else {
        object.requestId = []
        if (options.bytes !== Array) { object.requestId = $util.newBuffer(object.requestId) }
      }
      if (options.bytes === String) { object.box = '' } else {
        object.box = []
        if (options.bytes !== Array) { object.box = $util.newBuffer(object.box) }
      }
    }
    if (message.requestId != null && message.hasOwnProperty('requestId')) { object.requestId = options.bytes === String ? $util.base64.encode(message.requestId, 0, message.requestId.length) : options.bytes === Array ? Array.prototype.slice.call(message.requestId) : message.requestId }
    if (message.box != null && message.hasOwnProperty('box')) { object.box = options.bytes === String ? $util.base64.encode(message.box, 0, message.box.length) : options.bytes === Array ? Array.prototype.slice.call(message.box) : message.box }
    return object
  }
...
export const InviteRequest = $root.InviteRequest = (() => {
  ...
  InviteRequest.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.peerId != null && message.hasOwnProperty('peerId')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.peerId) }
    if (message.trusteePubKey != null && message.hasOwnProperty('trusteePubKey')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.trusteePubKey) }
    if (message.boxPubKey != null && message.hasOwnProperty('boxPubKey')) { writer.uint32(/* id 3, wireType 2 = */26).bytes(message.boxPubKey) }
    return writer
  }
  ...
  InviteRequest.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.InviteRequest()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  InviteRequest.verify = function verify (message) {
    ...
    if (message.boxPubKey != null && message.hasOwnProperty('boxPubKey')) {
      if (!(message.boxPubKey && typeof message.boxPubKey.length === 'number' || $util.isString(message.boxPubKey))) { return 'boxPubKey: buffer expected' }
    }
    return null
  }
  ...
  InviteRequest.fromObject = function fromObject (object) {
    if (object instanceof $root.InviteRequest) { return object }
    const message = new $root.InviteRequest()
    if (object.peerId != null) {
      if (typeof object.peerId === 'string') { $util.base64.decode(object.peerId, message.peerId = $util.newBuffer($util.base64.length(object.peerId)), 0) } else if (object.peerId.length) { message.peerId = object.peerId }
    }
    if (object.trusteePubKey != null) {
    ...
    if (object.boxPubKey != null) {
      if (typeof object.boxPubKey === 'string') { $util.base64.decode(object.boxPubKey, message.boxPubKey = $util.newBuffer($util.base64.length(object.boxPubKey)), 0) } else if (object.boxPubKey.length) { message.boxPubKey = object.boxPubKey }
    }
    return message
  }
  ...
  InviteRequest.toObject = function toObject (message, options) {
    ...
    if (options.defaults) {
      ...
      if (options.bytes === String) { object.boxPubKey = '' } else {
        object.boxPubKey = []
        if (options.bytes !== Array) { object.boxPubKey = $util.newBuffer(object.boxPubKey) }
      }
    }
    if (message.peerId != null && message.hasOwnProperty('peerId')) { object.peerId = options.bytes === String ? $util.base64.encode(message.peerId, 0, message.peerId.length) : options.bytes === Array ? Array.prototype.slice.call(message.peerId) : message.peerId }
    if (message.trusteePubKey != null && message.hasOwnProperty('trusteePubKey')) { object.trusteePubKey = options.bytes === String ? $util.base64.encode(message.trusteePubKey, 0, message.trusteePubKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.trusteePubKey) : message.trusteePubKey }
    if (message.boxPubKey != null && message.hasOwnProperty('boxPubKey')) { object.boxPubKey = options.bytes === String ? $util.base64.encode(message.boxPubKey, 0, message.boxPubKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.boxPubKey) : message.boxPubKey }
    return object
  }
...
export const ChannelMessage = $root.ChannelMessage = (() => {
  ...
  ChannelMessage.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.tbs != null && message.hasOwnProperty('tbs')) { $root.ChannelMessage.TBS.encode(message.tbs, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
    if (message.signature != null && message.hasOwnProperty('signature')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.signature) }
    return writer
  }
  ...
  ChannelMessage.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.ChannelMessage()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ChannelMessage.verify = function verify (message) {
    if (typeof message !== 'object' || message === null) { return 'object expected' }
    if (message.tbs != null && message.hasOwnProperty('tbs')) {
      const error = $root.ChannelMessage.TBS.verify(message.tbs)
      if (error) { return 'tbs.' + error }
    }
    if (message.signature != null && message.hasOwnProperty('signature')) {
      if (!(message.signature && typeof message.signature.length === 'number' || $util.isString(message.signature))) { return 'signature: buffer expected' }
  ...
  ChannelMessage.fromObject = function fromObject (object) {
    ...
    const message = new $root.ChannelMessage()
    if (object.tbs != null) {
      if (typeof object.tbs !== 'object') { throw TypeError('.ChannelMessage.tbs: object expected') }
  ...
  ChannelMessage.toObject = function toObject (message, options) {
    ...
    if (message.tbs != null && message.hasOwnProperty('tbs')) { object.tbs = $root.ChannelMessage.TBS.toObject(message.tbs, options) }
    if (message.signature != null && message.hasOwnProperty('signature')) { object.signature = options.bytes === String ? $util.base64.encode(message.signature, 0, message.signature.length) : options.bytes === Array ? Array.prototype.slice.call(message.signature) : message.signature }
    return object
  }
  ...
  ChannelMessage.Root = (function () {
    ...
    Root.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.ChannelMessage.Root()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          default:
    ...
    Root.fromObject = function fromObject (object) {
      if (object instanceof $root.ChannelMessage.Root) { return object }
  ...
  ChannelMessage.Body = (function () {
    ...
    Body.encode = function encode (message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.root != null && message.hasOwnProperty('root')) { $root.ChannelMessage.Root.encode(message.root, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
    ...
    Body.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.ChannelMessage.Body()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    Body.verify = function verify (message) {
      ...
      if (message.root != null && message.hasOwnProperty('root')) {
        properties.body = 1
        {
          const error = $root.ChannelMessage.Root.verify(message.root)
    ...
    Body.fromObject = function fromObject (object) {
      if (object instanceof $root.ChannelMessage.Body) { return object }
      const message = new $root.ChannelMessage.Body()
      if (object.root != null) {
        if (typeof object.root !== 'object') { throw TypeError('.ChannelMessage.Body.root: object expected') }
    ...
    Body.toObject = function toObject (message, options) {
      ...
      if (message.root != null && message.hasOwnProperty('root')) {
        ...
        if (options.oneofs) { object.body = 'root' }
      }
      if (message.json != null && message.hasOwnProperty('json')) {
        object.json = message.json
        if (options.oneofs) { object.body = 'json' }
      }
      return object
    }
  ...
  ChannelMessage.TBS = (function () {
    ...
    TBS.encode = function encode (message, writer) {
      ...
      if (message.parents != null && message.parents.length) {
        for (let i = 0; i < message.parents.length; ++i) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.parents[i]) }
      }
      if (message.height != null && message.hasOwnProperty('height')) { writer.uint32(/* id 2, wireType 0 = */16).int64(message.height) }
      if (message.chain != null && message.chain.length) {
        for (let i = 0; i < message.chain.length; ++i) { $root.Link.encode(message.chain[i], writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim() }
      }
      if (message.timestamp != null && message.hasOwnProperty('timestamp')) { writer.uint32(/* id 4, wireType 1 = */33).double(message.timestamp) }
      if (message.body != null && message.hasOwnProperty('body')) { $root.ChannelMessage.Body.encode(message.body, writer.uint32(/* id 5, wireType 2 = */42).fork()).ldelim() }
      return writer
    }
    ...
    TBS.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.ChannelMessage.TBS()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
            if (!(message.parents && message.parents.length)) { message.parents = [] }
    ...
    TBS.verify = function verify (message) {
      ...
      if (message.parents != null && message.hasOwnProperty('parents')) {
        if (!Array.isArray(message.parents)) { return 'parents: array expected' }
        for (let i = 0; i < message.parents.length; ++i) {
          if (!(message.parents[i] && typeof message.parents[i].length === 'number' || $util.isString(message.parents[i]))) { return 'parents: buffer[] expected' }
        }
      }
      if (message.height != null && message.hasOwnProperty('height')) {
        if (!$util.isInteger(message.height) && !(message.height && $util.isInteger(message.height.low) && $util.isInteger(message.height.high))) { return 'height: integer|Long expected' }
      }
      if (message.chain != null && message.hasOwnProperty('chain')) {
        if (!Array.isArray(message.chain)) { return 'chain: array expected' }
        for (let i = 0; i < message.chain.length; ++i) {
      ...
      if (message.timestamp != null && message.hasOwnProperty('timestamp')) {
        if (typeof message.timestamp !== 'number') { return 'timestamp: number expected' }
      }
      if (message.body != null && message.hasOwnProperty('body')) {
        const error = $root.ChannelMessage.Body.verify(message.body)
    ...
    /**
         ...
         */
    TBS.fromObject = function fromObject (object) {
      if (object instanceof $root.ChannelMessage.TBS) { return object }
      const message = new $root.ChannelMessage.TBS()
      if (object.parents) {
        if (!Array.isArray(object.parents)) { throw TypeError('.ChannelMessage.TBS.parents: array expected') }
        message.parents = []
        for (let i = 0; i < object.parents.length; ++i) {
          if (typeof object.parents[i] === 'string') { $util.base64.decode(object.parents[i], message.parents[i] = $util.newBuffer($util.base64.length(object.parents[i])), 0) } else if (object.parents[i].length) { message.parents[i] = object.parents[i] }
        }
      }
      ...
      if (object.chain) {
        if (!Array.isArray(object.chain)) { throw TypeError('.ChannelMessage.TBS.chain: array expected') }
        message.chain = []
        for (let i = 0; i < object.chain.length; ++i) {
          if (typeof object.chain[i] !== 'object') { throw TypeError('.ChannelMessage.TBS.chain: object expected') }
          message.chain[i] = $root.Link.fromObject(object.chain[i])
        }
      }
      if (object.timestamp != null) { message.timestamp = Number(object.timestamp) }
      if (object.body != null) {
        if (typeof object.body !== 'object') { throw TypeError('.ChannelMessage.TBS.body: object expected') }
    ...
    TBS.toObject = function toObject (message, options) {
      ...
      if (message.parents && message.parents.length) {
        object.parents = []
        for (let j = 0; j < message.parents.length; ++j) { object.parents[j] = options.bytes === String ? $util.base64.encode(message.parents[j], 0, message.parents[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.parents[j]) : message.parents[j] }
      }
      if (message.height != null && message.hasOwnProperty('height')) {
        if (typeof message.height === 'number') { object.height = options.longs === String ? String(message.height) : message.height } else { object.height = options.longs === String ? $util.Long.prototype.toString.call(message.height) : options.longs === Number ? new $util.LongBits(message.height.low >>> 0, message.height.high >>> 0).toNumber() : message.height }
      }
      if (message.chain && message.chain.length) {
        object.chain = []
        for (let j = 0; j < message.chain.length; ++j) { object.chain[j] = $root.Link.toObject(message.chain[j], options) }
      }
      if (message.timestamp != null && message.hasOwnProperty('timestamp')) { object.timestamp = options.json && !isFinite(message.timestamp) ? String(message.timestamp) : message.timestamp }
      if (message.body != null && message.hasOwnProperty('body')) { object.body = $root.ChannelMessage.Body.toObject(message.body, options) }
      return object
    }
...
export const Query = $root.Query = (() => {
  ...
  Query.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.height != null && message.hasOwnProperty('height')) { writer.uint32(/* id 1, wireType 0 = */8).int64(message.height) }
    if (message.hash != null && message.hasOwnProperty('hash')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.hash) }
    if (message.isBackward != null && message.hasOwnProperty('isBackward')) { writer.uint32(/* id 3, wireType 0 = */24).bool(message.isBackward) }
  ...
  Query.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Query()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Query.verify = function verify (message) {
    ...
    if (message.hash != null && message.hasOwnProperty('hash')) {
      if (properties.cursor === 1) { return 'cursor: multiple values' }
      properties.cursor = 1
    ...
    if (message.isBackward != null && message.hasOwnProperty('isBackward')) {
      if (typeof message.isBackward !== 'boolean') { return 'isBackward: boolean expected' }
    }
  ...
  Query.fromObject = function fromObject (object) {
    ...
    const message = new $root.Query()
    if (object.height != null) {
      if ($util.Long) { (message.height = $util.Long.fromValue(object.height)).unsigned = false } else if (typeof object.height === 'string') { message.height = parseInt(object.height, 10) } else if (typeof object.height === 'number') { message.height = object.height } else if (typeof object.height === 'object') { message.height = new $util.LongBits(object.height.low >>> 0, object.height.high >>> 0).toNumber() }
    }
    if (object.hash != null) {
      if (typeof object.hash === 'string') { $util.base64.decode(object.hash, message.hash = $util.newBuffer($util.base64.length(object.hash)), 0) } else if (object.hash.length) { message.hash = object.hash }
    }
    if (object.isBackward != null) { message.isBackward = Boolean(object.isBackward) }
  ...
  Query.toObject = function toObject (message, options) {
    ...
    if (message.height != null && message.hasOwnProperty('height')) {
      if (typeof message.height === 'number') { object.height = options.longs === String ? String(message.height) : message.height } else { object.height = options.longs === String ? $util.Long.prototype.toString.call(message.height) : options.longs === Number ? new $util.LongBits(message.height.low >>> 0, message.height.high >>> 0).toNumber() : message.height }
      if (options.oneofs) { object.cursor = 'height' }
    }
    if (message.hash != null && message.hasOwnProperty('hash')) {
      object.hash = options.bytes === String ? $util.base64.encode(message.hash, 0, message.hash.length) : options.bytes === Array ? Array.prototype.slice.call(message.hash) : message.hash
      if (options.oneofs) { object.cursor = 'hash' }
    }
    if (message.isBackward != null && message.hasOwnProperty('isBackward')) { object.isBackward = message.isBackward }
...
export const QueryResponse = $root.QueryResponse = (() => {
  ...
  QueryResponse.encode = function encode (message, writer) {
    ...
    if (message.abbreviatedMessages != null && message.abbreviatedMessages.length) {
      for (let i = 0; i < message.abbreviatedMessages.length; ++i) { $root.QueryResponse.Abbreviated.encode(message.abbreviatedMessages[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
    }
    if (message.forwardHash != null && message.hasOwnProperty('forwardHash')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.forwardHash) }
    if (message.backwardHash != null && message.hasOwnProperty('backwardHash')) { writer.uint32(/* id 3, wireType 2 = */26).bytes(message.backwardHash) }
    return writer
  }
  ...
  QueryResponse.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.QueryResponse()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
          if (!(message.abbreviatedMessages && message.abbreviatedMessages.length)) { message.abbreviatedMessages = [] }
  ...
  QueryResponse.verify = function verify (message) {
    ...
    if (message.abbreviatedMessages != null && message.hasOwnProperty('abbreviatedMessages')) {
      if (!Array.isArray(message.abbreviatedMessages)) { return 'abbreviatedMessages: array expected' }
      for (let i = 0; i < message.abbreviatedMessages.length; ++i) {
        const error = $root.QueryResponse.Abbreviated.verify(message.abbreviatedMessages[i])
        if (error) { return 'abbreviatedMessages.' + error }
      }
    }
    if (message.forwardHash != null && message.hasOwnProperty('forwardHash')) {
      if (!(message.forwardHash && typeof message.forwardHash.length === 'number' || $util.isString(message.forwardHash))) { return 'forwardHash: buffer expected' }
    }
    if (message.backwardHash != null && message.hasOwnProperty('backwardHash')) {
      if (!(message.backwardHash && typeof message.backwardHash.length === 'number' || $util.isString(message.backwardHash))) { return 'backwardHash: buffer expected' }
    }
    return null
  }
  ...
  QueryResponse.fromObject = function fromObject (object) {
    ...
    const message = new $root.QueryResponse()
    if (object.abbreviatedMessages) {
      if (!Array.isArray(object.abbreviatedMessages)) { throw TypeError('.QueryResponse.abbreviatedMessages: array expected') }
      message.abbreviatedMessages = []
      for (let i = 0; i < object.abbreviatedMessages.length; ++i) {
        if (typeof object.abbreviatedMessages[i] !== 'object') { throw TypeError('.QueryResponse.abbreviatedMessages: object expected') }
    ...
    if (object.forwardHash != null) {
      if (typeof object.forwardHash === 'string') { $util.base64.decode(object.forwardHash, message.forwardHash = $util.newBuffer($util.base64.length(object.forwardHash)), 0) } else if (object.forwardHash.length) { message.forwardHash = object.forwardHash }
    }
    if (object.backwardHash != null) {
      if (typeof object.backwardHash === 'string') { $util.base64.decode(object.backwardHash, message.backwardHash = $util.newBuffer($util.base64.length(object.backwardHash)), 0) } else if (object.backwardHash.length) { message.backwardHash = object.backwardHash }
    }
    return message
  }
  ...
  QueryResponse.toObject = function toObject (message, options) {
    if (!options) { options = {} }
    const object = {}
    if (options.arrays || options.defaults) { object.abbreviatedMessages = [] }
    if (options.defaults) {
      if (options.bytes === String) { object.forwardHash = '' } else {
        object.forwardHash = []
        if (options.bytes !== Array) { object.forwardHash = $util.newBuffer(object.forwardHash) }
      }
      if (options.bytes === String) { object.backwardHash = '' } else {
        object.backwardHash = []
        if (options.bytes !== Array) { object.backwardHash = $util.newBuffer(object.backwardHash) }
      }
    }
    if (message.abbreviatedMessages && message.abbreviatedMessages.length) {
      object.abbreviatedMessages = []
      for (let j = 0; j < message.abbreviatedMessages.length; ++j) { object.abbreviatedMessages[j] = $root.QueryResponse.Abbreviated.toObject(message.abbreviatedMessages[j], options) }
    }
    if (message.forwardHash != null && message.hasOwnProperty('forwardHash')) { object.forwardHash = options.bytes === String ? $util.base64.encode(message.forwardHash, 0, message.forwardHash.length) : options.bytes === Array ? Array.prototype.slice.call(message.forwardHash) : message.forwardHash }
    if (message.backwardHash != null && message.hasOwnProperty('backwardHash')) { object.backwardHash = options.bytes === String ? $util.base64.encode(message.backwardHash, 0, message.backwardHash.length) : options.bytes === Array ? Array.prototype.slice.call(message.backwardHash) : message.backwardHash }
    return object
  }
  ...
  QueryResponse.Abbreviated = (function () {
    ...
    Abbreviated.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.QueryResponse.Abbreviated()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    Abbreviated.fromObject = function fromObject (object) {
      if (object instanceof $root.QueryResponse.Abbreviated) { return object }
      const message = new $root.QueryResponse.Abbreviated()
      if (object.parents) {
        if (!Array.isArray(object.parents)) { throw TypeError('.QueryResponse.Abbreviated.parents: array expected') }
        message.parents = []
        for (let i = 0; i < object.parents.length; ++i) {
          if (typeof object.parents[i] === 'string') { $util.base64.decode(object.parents[i], message.parents[i] = $util.newBuffer($util.base64.length(object.parents[i])), 0) } else if (object.parents[i].length) { message.parents[i] = object.parents[i] }
        }
    ...
    Abbreviated.toObject = function toObject (message, options) {
      if (!options) { options = {} }
      const object = {}
      if (options.arrays || options.defaults) { object.parents = [] }
      if (options.defaults) {
...
export const Bulk = $root.Bulk = (() => {
  ...
  Bulk.encode = function encode (message, writer) {
    ...
    if (message.hashes != null && message.hashes.length) {
      for (let i = 0; i < message.hashes.length; ++i) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.hashes[i]) }
    }
    return writer
  }
  ...
  Bulk.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Bulk()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
          if (!(message.hashes && message.hashes.length)) { message.hashes = [] }
  ...
  Bulk.verify = function verify (message) {
    ...
    if (message.hashes != null && message.hasOwnProperty('hashes')) {
      if (!Array.isArray(message.hashes)) { return 'hashes: array expected' }
      for (let i = 0; i < message.hashes.length; ++i) {
        if (!(message.hashes[i] && typeof message.hashes[i].length === 'number' || $util.isString(message.hashes[i]))) { return 'hashes: buffer[] expected' }
      }
    }
    return null
  }
  ...
  Bulk.fromObject = function fromObject (object) {
    if (object instanceof $root.Bulk) { return object }
    const message = new $root.Bulk()
    if (object.hashes) {
      if (!Array.isArray(object.hashes)) { throw TypeError('.Bulk.hashes: array expected') }
      message.hashes = []
      for (let i = 0; i < object.hashes.length; ++i) {
        if (typeof object.hashes[i] === 'string') { $util.base64.decode(object.hashes[i], message.hashes[i] = $util.newBuffer($util.base64.length(object.hashes[i])), 0) } else if (object.hashes[i].length) { message.hashes[i] = object.hashes[i] }
      }
    }
    return message
  }
  ...
  Bulk.toObject = function toObject (message, options) {
    if (!options) { options = {} }
    const object = {}
    if (options.arrays || options.defaults) { object.hashes = [] }
    if (message.hashes && message.hashes.length) {
      object.hashes = []
      for (let j = 0; j < message.hashes.length; ++j) { object.hashes[j] = options.bytes === String ? $util.base64.encode(message.hashes[j], 0, message.hashes[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.hashes[j]) : message.hashes[j] }
    }
    return object
  }
...
export const BulkResponse = $root.BulkResponse = (() => {
  ...
  BulkResponse.encode = function encode (message, writer) {
    ...
    if (message.messages != null && message.messages.length) {
      for (let i = 0; i < message.messages.length; ++i) { $root.ChannelMessage.encode(message.messages[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
    }
    if (message.forwardIndex != null && message.hasOwnProperty('forwardIndex')) { writer.uint32(/* id 2, wireType 0 = */16).uint32(message.forwardIndex) }
    return writer
  }
  ...
  BulkResponse.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.BulkResponse()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  BulkResponse.verify = function verify (message) {
    ...
    if (message.messages != null && message.hasOwnProperty('messages')) {
      ...
      for (let i = 0; i < message.messages.length; ++i) {
        const error = $root.ChannelMessage.verify(message.messages[i])
        if (error) { return 'messages.' + error }
      }
    }
    if (message.forwardIndex != null && message.hasOwnProperty('forwardIndex')) {
      if (!$util.isInteger(message.forwardIndex)) { return 'forwardIndex: integer expected' }
    }
    return null
  }
  ...
  BulkResponse.fromObject = function fromObject (object) {
    if (object instanceof $root.BulkResponse) { return object }
    const message = new $root.BulkResponse()
    if (object.messages) {
      if (!Array.isArray(object.messages)) { throw TypeError('.BulkResponse.messages: array expected') }
      message.messages = []
      for (let i = 0; i < object.messages.length; ++i) {
        if (typeof object.messages[i] !== 'object') { throw TypeError('.BulkResponse.messages: object expected') }
        message.messages[i] = $root.ChannelMessage.fromObject(object.messages[i])
      }
    }
    if (object.forwardIndex != null) { message.forwardIndex = object.forwardIndex >>> 0 }
    return message
  }
  ...
  BulkResponse.toObject = function toObject (message, options) {
    ...
    if (options.defaults) { object.forwardIndex = 0 }
    if (message.messages && message.messages.length) {
      object.messages = []
      for (let j = 0; j < message.messages.length; ++j) { object.messages[j] = $root.ChannelMessage.toObject(message.messages[j], options) }
    }
    if (message.forwardIndex != null && message.hasOwnProperty('forwardIndex')) { object.forwardIndex = message.forwardIndex }
    return object
  }
...
export const SyncRequest = $root.SyncRequest = (() => {
  ...
  SyncRequest.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.channelId != null && message.hasOwnProperty('channelId')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.channelId) }
    if (message.seq != null && message.hasOwnProperty('seq')) { writer.uint32(/* id 2, wireType 0 = */16).uint32(message.seq) }
    if (message.nonce != null && message.hasOwnProperty('nonce')) { writer.uint32(/* id 3, wireType 2 = */26).bytes(message.nonce) }
    if (message.box != null && message.hasOwnProperty('box')) { writer.uint32(/* id 4, wireType 2 = */34).bytes(message.box) }
    return writer
  }
  ...
  SyncRequest.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.SyncRequest()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  SyncRequest.verify = function verify (message) {
    ...
    if (message.nonce != null && message.hasOwnProperty('nonce')) {
      if (!(message.nonce && typeof message.nonce.length === 'number' || $util.isString(message.nonce))) { return 'nonce: buffer expected' }
    }
    if (message.box != null && message.hasOwnProperty('box')) {
      if (!(message.box && typeof message.box.length === 'number' || $util.isString(message.box))) { return 'box: buffer expected' }
    }
  ...
  SyncRequest.fromObject = function fromObject (object) {
    if (object instanceof $root.SyncRequest) { return object }
    const message = new $root.SyncRequest()
    if (object.channelId != null) {
      if (typeof object.channelId === 'string') { $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0) } else if (object.channelId.length) { message.channelId = object.channelId }
    }
    if (object.seq != null) { message.seq = object.seq >>> 0 }
    if (object.nonce != null) {
      if (typeof object.nonce === 'string') { $util.base64.decode(object.nonce, message.nonce = $util.newBuffer($util.base64.length(object.nonce)), 0) } else if (object.nonce.length) { message.nonce = object.nonce }
    }
    if (object.box != null) {
      if (typeof object.box === 'string') { $util.base64.decode(object.box, message.box = $util.newBuffer($util.base64.length(object.box)), 0) } else if (object.box.length) { message.box = object.box }
    }
  ...
  SyncRequest.toObject = function toObject (message, options) {
    ...
    if (options.defaults) {
      ...
      object.seq = 0
      if (options.bytes === String) { object.nonce = '' } else {
        object.nonce = []
        if (options.bytes !== Array) { object.nonce = $util.newBuffer(object.nonce) }
      }
      if (options.bytes === String) { object.box = '' } else {
        object.box = []
        if (options.bytes !== Array) { object.box = $util.newBuffer(object.box) }
    ...
    if (message.nonce != null && message.hasOwnProperty('nonce')) { object.nonce = options.bytes === String ? $util.base64.encode(message.nonce, 0, message.nonce.length) : options.bytes === Array ? Array.prototype.slice.call(message.nonce) : message.nonce }
    if (message.box != null && message.hasOwnProperty('box')) { object.box = options.bytes === String ? $util.base64.encode(message.box, 0, message.box.length) : options.bytes === Array ? Array.prototype.slice.call(message.box) : message.box }
    return object
  }
  ...
  SyncRequest.TBS = (function () {
    ...
    TBS.encode = function encode (message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.chain != null && message.chain.length) {
        for (let i = 0; i < message.chain.length; ++i) { $root.Link.encode(message.chain[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
      }
      if (message.query != null && message.hasOwnProperty('query')) { $root.Query.encode(message.query, writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim() }
      if (message.bulk != null && message.hasOwnProperty('bulk')) { $root.Bulk.encode(message.bulk, writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim() }
      if (message.responsePubKey != null && message.hasOwnProperty('responsePubKey')) { writer.uint32(/* id 4, wireType 2 = */34).bytes(message.responsePubKey) }
      return writer
    }
    ...
    TBS.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.SyncRequest.TBS()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    TBS.verify = function verify (message) {
      ...
      if (message.query != null && message.hasOwnProperty('query')) {
        ...
        {
          const error = $root.Query.verify(message.query)
      ...
      if (message.bulk != null && message.hasOwnProperty('bulk')) {
        ...
        properties.content = 1
        {
          const error = $root.Bulk.verify(message.bulk)
          if (error) { return 'bulk.' + error }
        }
      }
      if (message.responsePubKey != null && message.hasOwnProperty('responsePubKey')) {
        if (!(message.responsePubKey && typeof message.responsePubKey.length === 'number' || $util.isString(message.responsePubKey))) { return 'responsePubKey: buffer expected' }
      }
      return null
    }
    ...
    /**
         ...
         */
    TBS.fromObject = function fromObject (object) {
      if (object instanceof $root.SyncRequest.TBS) { return object }
      const message = new $root.SyncRequest.TBS()
      if (object.chain) {
        if (!Array.isArray(object.chain)) { throw TypeError('.SyncRequest.TBS.chain: array expected') }
        message.chain = []
        for (let i = 0; i < object.chain.length; ++i) {
          if (typeof object.chain[i] !== 'object') { throw TypeError('.SyncRequest.TBS.chain: object expected') }
          message.chain[i] = $root.Link.fromObject(object.chain[i])
        }
      }
      if (object.query != null) {
        if (typeof object.query !== 'object') { throw TypeError('.SyncRequest.TBS.query: object expected') }
        message.query = $root.Query.fromObject(object.query)
      }
      if (object.bulk != null) {
        if (typeof object.bulk !== 'object') { throw TypeError('.SyncRequest.TBS.bulk: object expected') }
        message.bulk = $root.Bulk.fromObject(object.bulk)
      }
      if (object.responsePubKey != null) {
        if (typeof object.responsePubKey === 'string') { $util.base64.decode(object.responsePubKey, message.responsePubKey = $util.newBuffer($util.base64.length(object.responsePubKey)), 0) } else if (object.responsePubKey.length) { message.responsePubKey = object.responsePubKey }
      }
      return message
    }
    ...
    TBS.toObject = function toObject (message, options) {
      ...
      if (options.arrays || options.defaults) { object.chain = [] }
      if (options.defaults) {
        if (options.bytes === String) { object.responsePubKey = '' } else {
          object.responsePubKey = []
          if (options.bytes !== Array) { object.responsePubKey = $util.newBuffer(object.responsePubKey) }
        }
      }
      if (message.chain && message.chain.length) {
        object.chain = []
      ...
      if (message.bulk != null && message.hasOwnProperty('bulk')) {
        ...
        if (options.oneofs) { object.content = 'bulk' }
      }
      if (message.responsePubKey != null && message.hasOwnProperty('responsePubKey')) { object.responsePubKey = options.bytes === String ? $util.base64.encode(message.responsePubKey, 0, message.responsePubKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.responsePubKey) : message.responsePubKey }
      return object
    }
  ...
  SyncRequest.Content = (function () {
    ...
    Content.encode = function encode (message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.tbs != null && message.hasOwnProperty('tbs')) { $root.SyncRequest.TBS.encode(message.tbs, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
      if (message.signature != null && message.hasOwnProperty('signature')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.signature) }
      return writer
    }
    ...
    Content.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.SyncRequest.Content()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    Content.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.tbs != null && message.hasOwnProperty('tbs')) {
        const error = $root.SyncRequest.TBS.verify(message.tbs)
        if (error) { return 'tbs.' + error }
      }
      if (message.signature != null && message.hasOwnProperty('signature')) {
        if (!(message.signature && typeof message.signature.length === 'number' || $util.isString(message.signature))) { return 'signature: buffer expected' }
    ...
    Content.fromObject = function fromObject (object) {
      if (object instanceof $root.SyncRequest.Content) { return object }
      const message = new $root.SyncRequest.Content()
      if (object.tbs != null) {
        if (typeof object.tbs !== 'object') { throw TypeError('.SyncRequest.Content.tbs: object expected') }
    ...
    Content.toObject = function toObject (message, options) {
      ...
      if (message.tbs != null && message.hasOwnProperty('tbs')) { object.tbs = $root.SyncRequest.TBS.toObject(message.tbs, options) }
      if (message.signature != null && message.hasOwnProperty('signature')) { object.signature = options.bytes === String ? $util.base64.encode(message.signature, 0, message.signature.length) : options.bytes === Array ? Array.prototype.slice.call(message.signature) : message.signature }
      return object
    }
...
export const SyncResponse = $root.SyncResponse = (() => {
  ...
  SyncResponse.encode = function encode (message, writer) {
    ...
    if (message.channelId != null && message.hasOwnProperty('channelId')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.channelId) }
    if (message.seq != null && message.hasOwnProperty('seq')) { writer.uint32(/* id 2, wireType 0 = */16).uint32(message.seq) }
    if (message.box != null && message.hasOwnProperty('box')) { writer.uint32(/* id 3, wireType 2 = */26).bytes(message.box) }
    return writer
  }
  ...
  SyncResponse.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.SyncResponse()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  SyncResponse.fromObject = function fromObject (object) {
    if (object instanceof $root.SyncResponse) { return object }
    const message = new $root.SyncResponse()
    if (object.channelId != null) {
      if (typeof object.channelId === 'string') { $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0) } else if (object.channelId.length) { message.channelId = object.channelId }
    }
    if (object.seq != null) { message.seq = object.seq >>> 0 }
  ...
  SyncResponse.Content = (function () {
    ...
    Content.encode = function encode (message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.queryResponse != null && message.hasOwnProperty('queryResponse')) { $root.QueryResponse.encode(message.queryResponse, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
      if (message.bulkResponse != null && message.hasOwnProperty('bulkResponse')) { $root.BulkResponse.encode(message.bulkResponse, writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim() }
      return writer
    }
    ...
    Content.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.SyncResponse.Content()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    Content.verify = function verify (message) {
      ...
      if (message.queryResponse != null && message.hasOwnProperty('queryResponse')) {
        properties.content = 1
        {
          const error = $root.QueryResponse.verify(message.queryResponse)
          if (error) { return 'queryResponse.' + error }
        }
      }
      if (message.bulkResponse != null && message.hasOwnProperty('bulkResponse')) {
        ...
        properties.content = 1
        {
          const error = $root.BulkResponse.verify(message.bulkResponse)
          if (error) { return 'bulkResponse.' + error }
        }
      }
      return null
    }
    ...
    /**
         ...
         */
    Content.fromObject = function fromObject (object) {
      if (object instanceof $root.SyncResponse.Content) { return object }
      const message = new $root.SyncResponse.Content()
      if (object.queryResponse != null) {
        if (typeof object.queryResponse !== 'object') { throw TypeError('.SyncResponse.Content.queryResponse: object expected') }
        message.queryResponse = $root.QueryResponse.fromObject(object.queryResponse)
      }
      if (object.bulkResponse != null) {
        if (typeof object.bulkResponse !== 'object') { throw TypeError('.SyncResponse.Content.bulkResponse: object expected') }
    ...
    Content.toObject = function toObject (message, options) {
      ...
      if (message.queryResponse != null && message.hasOwnProperty('queryResponse')) {
        ...
        if (options.oneofs) { object.content = 'queryResponse' }
      }
      if (message.bulkResponse != null && message.hasOwnProperty('bulkResponse')) {
        object.bulkResponse = $root.BulkResponse.toObject(message.bulkResponse, options)
        if (options.oneofs) { object.content = 'bulkResponse' }
      }
      return object
    }
...
export const Error = $root.Error = (() => {
  ...
  Error.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.reason != null && message.hasOwnProperty('reason')) { writer.uint32(/* id 1, wireType 2 = */10).string(message.reason) }
    return writer
  }
  ...
  Error.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Error()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const Notification = $root.Notification = (() => {
  ...
  Notification.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Notification()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Notification.fromObject = function fromObject (object) {
    if (object instanceof $root.Notification) { return object }
    const message = new $root.Notification()
    if (object.channelId != null) {
      if (typeof object.channelId === 'string') { $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0) } else if (object.channelId.length) { message.channelId = object.channelId }
    }
    return message
...
export const Ping = $root.Ping = (() => {
  ...
  Ping.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.seq != null && message.hasOwnProperty('seq')) { writer.uint32(/* id 1, wireType 0 = */8).uint32(message.seq) }
    return writer
  }
  ...
  Ping.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Ping()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Ping.toObject = function toObject (message, options) {
    if (!options) { options = {} }
    const object = {}
    if (options.defaults) { object.seq = 0 }
    if (message.seq != null && message.hasOwnProperty('seq')) { object.seq = message.seq }
    return object
  }
...
export const Pong = $root.Pong = (() => {
  ...
  Pong.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Pong()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const Packet = $root.Packet = (() => {
  ...
  Packet.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.error != null && message.hasOwnProperty('error')) { $root.Error.encode(message.error, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
    if (message.invite != null && message.hasOwnProperty('invite')) { $root.EncryptedInvite.encode(message.invite, writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim() }
    if (message.syncRequest != null && message.hasOwnProperty('syncRequest')) { $root.SyncRequest.encode(message.syncRequest, writer.uint32(/* id 3, wireType 2 = */26).fork()).ldelim() }
    if (message.syncResponse != null && message.hasOwnProperty('syncResponse')) { $root.SyncResponse.encode(message.syncResponse, writer.uint32(/* id 4, wireType 2 = */34).fork()).ldelim() }
    if (message.notification != null && message.hasOwnProperty('notification')) { $root.Notification.encode(message.notification, writer.uint32(/* id 5, wireType 2 = */42).fork()).ldelim() }
    if (message.ping != null && message.hasOwnProperty('ping')) { $root.Ping.encode(message.ping, writer.uint32(/* id 6, wireType 2 = */50).fork()).ldelim() }
    if (message.pong != null && message.hasOwnProperty('pong')) { $root.Pong.encode(message.pong, writer.uint32(/* id 7, wireType 2 = */58).fork()).ldelim() }
    return writer
  }
  ...
  Packet.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Packet()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Packet.verify = function verify (message) {
    ...
    if (message.error != null && message.hasOwnProperty('error')) {
      properties.content = 1
      {
        const error = $root.Error.verify(message.error)
    ...
    if (message.invite != null && message.hasOwnProperty('invite')) {
      ...
      properties.content = 1
      {
        const error = $root.EncryptedInvite.verify(message.invite)
        if (error) { return 'invite.' + error }
      }
    }
    if (message.syncRequest != null && message.hasOwnProperty('syncRequest')) {
      ...
      properties.content = 1
      {
        const error = $root.SyncRequest.verify(message.syncRequest)
    ...
    if (message.syncResponse != null && message.hasOwnProperty('syncResponse')) {
      ...
      properties.content = 1
      {
        const error = $root.SyncResponse.verify(message.syncResponse)
        if (error) { return 'syncResponse.' + error }
      }
    }
    if (message.notification != null && message.hasOwnProperty('notification')) {
      ...
      properties.content = 1
      {
        const error = $root.Notification.verify(message.notification)
    ...
    if (message.ping != null && message.hasOwnProperty('ping')) {
      ...
      properties.content = 1
      {
        const error = $root.Ping.verify(message.ping)
    ...
    if (message.pong != null && message.hasOwnProperty('pong')) {
      ...
      properties.content = 1
      {
        const error = $root.Pong.verify(message.pong)
  ...
  Packet.fromObject = function fromObject (object) {
    if (object instanceof $root.Packet) { return object }
    const message = new $root.Packet()
    if (object.error != null) {
      if (typeof object.error !== 'object') { throw TypeError('.Packet.error: object expected') }
      message.error = $root.Error.fromObject(object.error)
    }
    if (object.invite != null) {
      if (typeof object.invite !== 'object') { throw TypeError('.Packet.invite: object expected') }
      message.invite = $root.EncryptedInvite.fromObject(object.invite)
    }
    if (object.syncRequest != null) {
      if (typeof object.syncRequest !== 'object') { throw TypeError('.Packet.syncRequest: object expected') }
      message.syncRequest = $root.SyncRequest.fromObject(object.syncRequest)
    }
    if (object.syncResponse != null) {
      if (typeof object.syncResponse !== 'object') { throw TypeError('.Packet.syncResponse: object expected') }
      message.syncResponse = $root.SyncResponse.fromObject(object.syncResponse)
    }
    if (object.notification != null) {
      if (typeof object.notification !== 'object') { throw TypeError('.Packet.notification: object expected') }
      message.notification = $root.Notification.fromObject(object.notification)
    }
    if (object.ping != null) {
      if (typeof object.ping !== 'object') { throw TypeError('.Packet.ping: object expected') }
      message.ping = $root.Ping.fromObject(object.ping)
    }
    if (object.pong != null) {
      if (typeof object.pong !== 'object') { throw TypeError('.Packet.pong: object expected') }
...
export const Identity = $root.Identity = (() => {
  ...
  Identity.encode = function encode (message, writer) {
    ...
    if (message.publicKey != null && message.hasOwnProperty('publicKey')) { writer.uint32(/* id 2, wireType 2 = */18).bytes(message.publicKey) }
    if (message.secretKey != null && message.hasOwnProperty('secretKey')) { writer.uint32(/* id 3, wireType 2 = */26).bytes(message.secretKey) }
    if (message.channelChains != null && message.channelChains.length) {
      for (let i = 0; i < message.channelChains.length; ++i) { $root.Identity.ChannelChain.encode(message.channelChains[i], writer.uint32(/* id 4, wireType 2 = */34).fork()).ldelim() }
    }
    if (message.metadata != null && message.hasOwnProperty('metadata')) { writer.uint32(/* id 5, wireType 2 = */42).string(message.metadata) }
    return writer
  }
  ...
  Identity.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Identity()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
        ...
        case 3:
          ...
          break
        case 4:
          if (!(message.channelChains && message.channelChains.length)) { message.channelChains = [] }
  ...
  Identity.verify = function verify (message) {
    ...
    if (message.secretKey != null && message.hasOwnProperty('secretKey')) {
      if (!(message.secretKey && typeof message.secretKey.length === 'number' || $util.isString(message.secretKey))) { return 'secretKey: buffer expected' }
    }
    if (message.channelChains != null && message.hasOwnProperty('channelChains')) {
      if (!Array.isArray(message.channelChains)) { return 'channelChains: array expected' }
      for (let i = 0; i < message.channelChains.length; ++i) {
        const error = $root.Identity.ChannelChain.verify(message.channelChains[i])
        if (error) { return 'channelChains.' + error }
      }
    }
  ...
  Identity.fromObject = function fromObject (object) {
    if (object instanceof $root.Identity) { return object }
    const message = new $root.Identity()
    if (object.name != null) { message.name = String(object.name) }
    if (object.publicKey != null) {
      if (typeof object.publicKey === 'string') { $util.base64.decode(object.publicKey, message.publicKey = $util.newBuffer($util.base64.length(object.publicKey)), 0) } else if (object.publicKey.length) { message.publicKey = object.publicKey }
    }
    if (object.secretKey != null) {
      if (typeof object.secretKey === 'string') { $util.base64.decode(object.secretKey, message.secretKey = $util.newBuffer($util.base64.length(object.secretKey)), 0) } else if (object.secretKey.length) { message.secretKey = object.secretKey }
    }
    if (object.channelChains) {
      if (!Array.isArray(object.channelChains)) { throw TypeError('.Identity.channelChains: array expected') }
      message.channelChains = []
      for (let i = 0; i < object.channelChains.length; ++i) {
        if (typeof object.channelChains[i] !== 'object') { throw TypeError('.Identity.channelChains: object expected') }
  ...
  Identity.toObject = function toObject (message, options) {
    if (!options) { options = {} }
    const object = {}
    if (options.arrays || options.defaults) { object.channelChains = [] }
    if (options.defaults) {
      object.name = ''
      ...
      if (options.bytes === String) { object.secretKey = '' } else {
        object.secretKey = []
        if (options.bytes !== Array) { object.secretKey = $util.newBuffer(object.secretKey) }
      }
      object.metadata = ''
    }
    ...
    if (message.secretKey != null && message.hasOwnProperty('secretKey')) { object.secretKey = options.bytes === String ? $util.base64.encode(message.secretKey, 0, message.secretKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.secretKey) : message.secretKey }
    if (message.channelChains && message.channelChains.length) {
      object.channelChains = []
      for (let j = 0; j < message.channelChains.length; ++j) { object.channelChains[j] = $root.Identity.ChannelChain.toObject(message.channelChains[j], options) }
    }
  ...
  Identity.ChannelChain = (function () {
    ...
    ChannelChain.encode = function encode (message, writer) {
      ...
      if (message.links != null && message.links.length) {
        for (let i = 0; i < message.links.length; ++i) { $root.Link.encode(message.links[i], writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim() }
      }
      return writer
    }
    ...
    ChannelChain.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Identity.ChannelChain()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    ChannelChain.verify = function verify (message) {
      ...
      if (message.links != null && message.hasOwnProperty('links')) {
        ...
        for (let i = 0; i < message.links.length; ++i) {
          const error = $root.Link.verify(message.links[i])
    ...
    ChannelChain.fromObject = function fromObject (object) {
      if (object instanceof $root.Identity.ChannelChain) { return object }
      const message = new $root.Identity.ChannelChain()
      if (object.channelId != null) {
        if (typeof object.channelId === 'string') { $util.base64.decode(object.channelId, message.channelId = $util.newBuffer($util.base64.length(object.channelId)), 0) } else if (object.channelId.length) { message.channelId = object.channelId }
      }
      if (object.links) {
        if (!Array.isArray(object.links)) { throw TypeError('.Identity.ChannelChain.links: array expected') }
        message.links = []
        for (let i = 0; i < object.links.length; ++i) {
          if (typeof object.links[i] !== 'object') { throw TypeError('.Identity.ChannelChain.links: object expected') }
    ...
    ChannelChain.toObject = function toObject (message, options) {
      if (!options) { options = {} }
      const object = {}
      if (options.arrays || options.defaults) { object.links = [] }
      if (options.defaults) {
        if (options.bytes === String) { object.channelId = '' } else {
          object.channelId = []
          if (options.bytes !== Array) { object.channelId = $util.newBuffer(object.channelId) }
      ...
      if (message.links && message.links.length) {
        object.links = []
        for (let j = 0; j < message.links.length; ++j) { object.links[j] = $root.Link.toObject(message.links[j], options) }
      }
      return object
    }
...
export const Channel = $root.Channel = (() => {
  ...
  Channel.encode = function encode (message, writer) {
    if (!writer) { writer = $Writer.create() }
    if (message.publicKey != null && message.hasOwnProperty('publicKey')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.publicKey) }
    if (message.name != null && message.hasOwnProperty('name')) { writer.uint32(/* id 2, wireType 2 = */18).string(message.name) }
    if (message.isFeed != null && message.hasOwnProperty('isFeed')) { writer.uint32(/* id 3, wireType 0 = */24).bool(message.isFeed) }
    if (message.metadata != null && message.hasOwnProperty('metadata')) { writer.uint32(/* id 4, wireType 2 = */34).string(message.metadata) }
    return writer
  }
  ...
  Channel.decode = function decode (reader, length) {
    if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
    const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.Channel()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  Channel.verify = function verify (message) {
    ...
    if (message.isFeed != null && message.hasOwnProperty('isFeed')) {
      if (typeof message.isFeed !== 'boolean') { return 'isFeed: boolean expected' }
    }
    if (message.metadata != null && message.hasOwnProperty('metadata')) {
      if (!$util.isString(message.metadata)) { return 'metadata: string expected' }
    }
  ...
  Channel.fromObject = function fromObject (object) {
    if (object instanceof $root.Channel) { return object }
    const message = new $root.Channel()
    if (object.publicKey != null) {
      if (typeof object.publicKey === 'string') { $util.base64.decode(object.publicKey, message.publicKey = $util.newBuffer($util.base64.length(object.publicKey)), 0) } else if (object.publicKey.length) { message.publicKey = object.publicKey }
    }
    if (object.name != null) { message.name = String(object.name) }
    if (object.isFeed != null) { message.isFeed = Boolean(object.isFeed) }
    if (object.metadata != null) { message.metadata = String(object.metadata) }
    return message
  }
  ...
  Channel.toObject = function toObject (message, options) {
    ...
    if (message.publicKey != null && message.hasOwnProperty('publicKey')) { object.publicKey = options.bytes === String ? $util.base64.encode(message.publicKey, 0, message.publicKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.publicKey) : message.publicKey }
    if (message.name != null && message.hasOwnProperty('name')) { object.name = message.name }
    if (message.isFeed != null && message.hasOwnProperty('isFeed')) { object.isFeed = message.isFeed }
    if (message.metadata != null && message.hasOwnProperty('metadata')) { object.metadata = message.metadata }
    return object
  }
